                        ...
                        <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center">
                                        <div class="p-5">
                                            <h1 class="fw-bolder">{{ $item->concert_name }}</h1>
                                            <p style="bottom: 0%; position: absolute;"><span class="text-gradient d-inline">{{ 'RP '.number_format($item->ticket_price, 0, ',', '.'); }}</p>
                                        </div>
                                        <img style="margin-left: auto;" class="img-fluid" src="https://dummyimage.com/300x400/343a40/6c757d" alt="..."/>
                                    </div>
                                </div>
                            </div>
                        @endforeach
