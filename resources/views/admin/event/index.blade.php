                ...
                {{-- <img class="profile-img" src="{{ asset('uphoria.png') }}" alt="..." /> --}}
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                            <li class="nav-item"><a class="nav-link" href="/ticket">Customer</a></li>
                            <li class="nav-item"><a class="nav-link" href="/wishlist">Transaction</a></li>
                            <li class="nav-item"><a class="nav-link" href="/ticket">Ticket</a></li>
                            <li class="nav-item"><a class="nav-link" href="/wishlist">Event/Concert</a></li>
