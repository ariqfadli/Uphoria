...
->
            {{-- <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                ...
                <img class="profile-img" src="assets/uphoria.png" alt="..." />
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                        <li class="nav-item"><a class="nav-link" href="/login">Ticket</a></li>
                        <li class="nav-item"><a class="nav-link" href="/login">Wishlist</a></li>
                        <li class="nav-item"><a class="nav-link" href="/login">Notification</a></li>
                ...
                <div class="container px-5 pb-5">
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            <!-- Header text content-->
                            <div class="text-center text-xxl-start">
                                <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient text-right d-inline">SBS MTV The Kpop Show Ticket  Package</span></h1>
                                <p class="lead fw-light mb-4">Look no further! Our SBS The Show tickets are the simplest way for you to experience a live Kpop recording.</p>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
